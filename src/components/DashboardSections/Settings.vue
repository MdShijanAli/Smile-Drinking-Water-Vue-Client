                        ...
                        >
                          <label for="fileInput" class="cursor-pointer group">
                            ...
                            <svg
                              ...
                              stroke-width="1.5"
                              stroke="currentColor"
                              class="w-full h-full bg-primary text-white p-4"
                            >
                              <path
                      ...
                      <div class="mt-5">
                        ...
                        <div class="mt-5">
                          <div class="relative">
                            ...
                            <input
                              ...
                              id="websitename"
                              type="text"
                              class="peer py-3 px-4 mt-2 block w-full bg-gray-100 border-transparent rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-gray-700 dark:border-transparent dark:text-gray-400 dark:focus:ring-gray-600"
                            />
                          </div>

                          <div class="relative my-5">
                            <label for="websiteaddress" class="font-semibold"
                        ...
                        <div class="pt-5">
                          ...
                          <div class="flex justify-end mt-5">
                            <button type="submit" class="px-10 py-3 bg-primary text-white">
                              Update
                            </button>
                          </div>
                        </div>
                  ...
                  <div class="">
                      <div class="my-5">
                        <label class="block font-semibold">Current Password</label>
                         <input v-model="currentPassword" type="password" placeholder="Current Password" class="border px-5 py-3 w-full mt-2">
                      </div>
                      <div class="my-5">
                        <label class="block font-semibold">New Password</label>
                         <input v-model="newPassword" type="password" placeholder="New Password" class="border px-5 py-3 w-full mt-2">
                      </div>
                      <div class="my-5">
                        <label class="block font-semibold">Confirm Password</label>
                         <input v-model="confirmPassword" type="password" placeholder="Confirm Password" class="border px-5 py-3 w-full mt-2">
                      </div>
...
const updatePassword = () => {
  ...
  if (auth.value.password !== currentPassword.value) {
    toast.add({
        severity: "error",
        summary: "Error",
    ...
    toast.add({
        severity: "error",
        summary: "Error",
        detail: "New Password and Current Password Not Matched",
        life: 3000,
      });
    return
  }
    ...
    axios.put(`https://server.zealtechweb.com/api/auth/update/${auth.value.id}`, updateData)
      .then(response => {
        ...
        // Optionally, you might want to update the auth object with the new password
        auth.value.password = newPassword.value;
      })
      .catch(error => {
        ...
        severity: "error",
        summary: "Error",
        detail: "Passowrd don't update succesfully",
        life: 3000,
      });
      });
  }
  ...
  try {
    ...
    if (response.ok) {
      ...
      toast.add({
        severity: "success",
        summary: "Successful",
        detail: "Website Details Update Successfully",
        life: 3000,
      });
    } else {
...
watchEffect(() => {
  ...
  if (websiteInfos.value && websiteInfos.value[0]) {
    ...
    websiteaddress.value =
      websiteInfos.value[0].websiteAddress || "Enter Website Address";
